    ...
    @csrf
        <div class="flex gap-6 justify-between">
            ...
            <div class="flex flex-col gap-1 w-1/2">
                ...
                <input type="text" id="sobrenome" name="sobrenome" class="px-2 py-1.5 rounded-0 border-b-2 focus:border-blue-500" required>
            </div>
        </div>
        <div class="flex flex-col gap-1">
            <label for="idade">Idade</label>
            <input type="number" id="idade" name="idade" class="px-2 py-1.5 rounded-0 border-b-2 focus:border-blue-500" min="15" max="99" required>
        </div>
        <div class="flex flex-col gap-1">
            <label for="email">Email</label>
            <input type="email" id="email" name="email" class="px-2 py-1.5 rounded-0 border-b-2 focus:border-blue-500" required>
        </div>
        <div class="flex items-center w-full gap-6 ">
            <div class="flex flex-col gap-1 w-1/2">
                <label for="nome">Telefone</label>
                <input type="tel" id="telefone" name="telefone" class="px-2 py-1.5 rounded-0 border-b-2 focus:border-blue-500" required>
            </div>
